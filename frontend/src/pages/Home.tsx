...
const Home = () => {
  return (
    <div className="min-h-screen bg-soil-bg">
      ...
      <section className="py-16 md:py-20 bg-soil-bg">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-soil-text mb-4">Quick Analysis</h2>
            <p className="text-soil-muted">Enter your soil data for instant insights</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#0a150f]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-soil-text mb-4">Our Services</h2>
            <p className="text-soil-muted">Comprehensive soil analysis tools</p>
          </div>
      ...
      <section id="how-it-works" className="py-16 md:py-20 bg-soil-bg">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-soil-text mb-4">How It Works</h2>
            <p className="text-soil-muted">Simple steps to analyze your soil</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              >
                <div className="w-10 h-10 rounded-full bg-primary-600 text-soil-text font-bold flex items-center justify-center mb-6 ring-4 ring-soil-dark">
                  {index + 1}
                </div>
                <h3 className="text-xl font-bold text-soil-text mb-3">{step.title}</h3>
                <p className="text-soil-muted text-sm leading-relaxed">{step.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
