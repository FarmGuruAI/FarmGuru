      ...
      <section className="py-16 md:py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Quick Analysis</h2>
            <p className="text-muted-foreground">Enter your soil data for instant insights</p>
          </div>
      ...
      <section id="how-it-works" className="py-16 md:py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">Simple steps to analyze your soil</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              >
                <div className="w-10 h-10 rounded-full bg-primary text-primary-foreground font-bold flex items-center justify-center mb-6 ring-4 ring-primary/20 shadow-lg shadow-primary/30">
                  {index + 1}
                </div>
